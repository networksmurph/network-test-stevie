...
-Level 5: Awareness Understands common basic applications enough to identify proper solutions, but cannot implement the solutions themselves without assistance.
-Level 6: Beginner You’re just starting to explore this skill in a practical environment and are able to implement basic solutions with little or no assistance.
-Level 7: Familiar You have basic practical knowledge of the skill, but plenty of room to learn more.
-Level 8: Proficient You’re comfortable in using this skill in routine ways.
